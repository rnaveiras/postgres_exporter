...
* Metrics about the oldest transaction and backend
  ([8](https://github.com/rnaveiras/postgres_exporter/pull/8))
* Added `postgres_in_recovery` metric
  ([7](https://github.com/rnaveiras/postgres_exporter/pull/7)
* Replaced lib/pq with jackc/pgx
  ([#6](https://github.com/rnaveiras/postgres_exporter/pull/6))
